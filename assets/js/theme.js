...
//
// 移植自上游 RP-Hub 1.9.6（1.9.7 优化了观感），本机保持同一套接口：
//   - 主题存在 localStorage 的 rphub-appearance，取值 dark / light
//   - 通过 <html data-app-theme="..."> 驱动 theme.css
//   - 三个入口（主页面 / character / novel）用 postMessage 同步
// 必须在 <head> 里、样式之前同步执行，否则深色下会先闪一下白屏。
(function () {
